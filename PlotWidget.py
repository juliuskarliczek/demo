...
class PlotWidget(QtWidgets.QTabWidget):
    def __init__(self, param_a, param_b, show_graphs, int_identifier):
        ...
        self.tabs = []
        self.createNewTab(param_a, param_b, show_graphs, int_identifier)

    def createNewTab(self, param_a, param_b, show_graphs, int_identifier):
        ...
        if not (int_identifier in self.int_identifiers):
            ...
            layout.addWidget(SubTabs(param_a, param_b, show_graphs))
